...
function gallery()
{
  ...
  while ($row = $stmt->fetch()) {
      ...
      echo '<img src="'.$row['path'].'"class="gallery-image" alt=""></a>';
      echo '<div class="gallery-item-info">';
      echo '<ul>';
      echo '<li class="gallery-item-likes"><span class="visually-hidden">Likes:</span></i> 56</li>';
      echo '<li class="gallery-item-comments"><span class="visually-hidden">Comments:</span></i> 2</li>';
      echo '</ul>';
      echo '</div>';
      echo '</div>';
  }
